...
export const CallPanel = () => {
  ...
  return (
    <section className="absolute left-4 bottom-0 w-[36rem] bg-white border border-gray-300 rounded-lg shadow-lg z-50">
      ...
      <ul className="max-h-60 overflow-y-auto">
        {calls.length > 0 ? (
          calls.map((call) => (
            <li
              key={call.callId}
              className="flex flex-row justify-between items-center p-2 border-b border-gray-500 text-3xl font-medium"
            >
              <span>
